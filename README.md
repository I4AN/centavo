...
| Auth | Firebase Auth obligatorio | Modo demo abierto (auth en el roadmap) |
...
npm run db:seed   # categorías + 3 meses de datos de ejemplo (precios de Bogotá)
npm run dev
```

Abre http://localhost:3000 — el seed deja agosto de 2026 con movimientos, presupuestos (uno excedido a propósito) y salario registrado.
...
- [ ] Autenticación multiusuario (Auth.js) y datos por usuario
